# Generated by Powerlevel10k configuration wizard on 2020-08-25 at 17:27 UTC.
...
# sharp heads, flat tails, 2 lines, solid, no frame, compact, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    build_version           # AKS Standalone build version
    azure_group             # azure account name (https://docs.microsoft.com/en-us/cli/azure)
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    my_reboot_required      # Flag that a reboot is required
  ...
  [[ -f /etc/lsb-release ]] && {
    . /etc/lsb-release
    [[ "$DISTRIB_ID" == "Ubuntu" ]] && typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=''
    [[ "$DISTRIB_ID" == "Arch" ]] && typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=''
  } || {
    command -v dpkg >/dev/null 2>&1 && typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=''
    command -v pacman >/dev/null 2>&1 && typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=''
  }
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|stern|kubelogin|kustomize|flux'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*/default' DEFAULTNS
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_SYSTEM_FOREGROUND=196
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULTNS_FOREGROUND=134
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=118
  ...
  typeset -g POWERLEVEL9K_AZURE_GROUP_SHOW_ON_COMMAND='az|terraform|pulumi|terragrunt'
  # Azure account name color.
  typeset -g POWERLEVEL9K_AZURE_FOREGROUND=32
  typeset -g POWERLEVEL9K_AZURE_GROUP_FOREGROUND=32
  # Custom icon.
  typeset -g POWERLEVEL9K_AZURE_VISUAL_IDENTIFIER_EXPANSION='ﴃ'
  typeset -g POWERLEVEL9K_AZURE_GROUP_VISUAL_IDENTIFIER_EXPANSION='ﴃ'
  typeset -g POWERLEVEL9K_AZURE_ENVIRONMENT_VISUAL_IDENTIFIER_EXPANSION='ﴃ'
  typeset -g POWERLEVEL9K_BUILD_VERSION_VISUAL_IDENTIFIER_EXPANSION='ﴃ'
  ...
  prompt_build_version() {
    [[ -z "$BUILD_VERSION_STRING" ]] || \
      _p9k_prompt_segment "$0" "blue" "white" "AZURE_ICON" 0 '' "$BUILD_VERSION_STRING"
  }

  prompt_azure_environment() {
    [[ -z "$AZURE_ENVIRONMENT_NAME" ]] || \
      _p9k_prompt_segment "$0" "blue" "white" "AZURE_ICON" 0 '' "$AZURE_ENVIRONMENT_NAME"
  }

  prompt_azure_group() {
    local cfg=${AZURE_CONFIG_DIR:-$HOME/.azure}/azureProfile.json
    local cfg2=${AZURE_CONFIG_DIR:-$HOME/.azure}/config
    if ! _p9k_cache_stat_get $0 $cfg $cfg2; then
      local name
      ...
      local group="$(az configure -l --query "[?@.name=='group'].value" -o tsv)"
      _p9k_cache_stat_set "$name${group:+"/$group"}"
    fi
    [[ -n $_p9k__cache_val[1] ]] || return
    _p9k_prompt_segment "$0" "blue" "white" "AZURE_ICON" 0 '' "${_p9k__cache_val[1]//\%/%%}"
  }

  prompt_my_reboot_required() {
